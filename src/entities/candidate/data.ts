...
export const candidateData: Candidate = {
  name: 'Сергей Котенко',
  title: 'Frontend-разработчик (React / Vue / Next.js / TypeScript / NodeJs)',
  summary:
  ...
  experience: [
    {
      ...
      period: 'Июль 2023 — Апрель 2026 (2 года 10 месяцев)',
      description: [
    ...
    },
    {
      ...
      position: 'Frontend-разработчик',
      period: 'Октябрь 2021 — Июль 2023 (1 год 10 месяцев)',
      description: [
    ...
    },
    {
      ...
      position: 'Frontend-разработчик',
      period: 'Май 2020 — Октябрь 2021 (1 год 6 месяцев)',
      description: [
